...
- ✅ `Successfully applied X migrations to schema` （データベース初期化完了）
...
**✅ サンプルデータ:**
- 5-10件程度のサンプルユーザーが表示されている
- 各ユーザーに「フロントエンド開発者」「バックエンド開発者」などのカテゴリ
- 「アクティブ」「非アクティブ」などのステータス
